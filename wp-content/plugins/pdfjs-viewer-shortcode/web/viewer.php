          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <button <?php if ($_GET["print"] != "true") { echo 'style="display:none;"'; }else{ echo 'style="display:inline-block!important;"';} ?> id="print" class="toolbarButton print hiddenMediumView" title="Print" tabindex="14" data-l10n-id="print">
                    <span data-l10n-id="print_label">Print</span>
                </button>
